...
/**
 * An interface representing a collection (container) of Pixel2D objects.
 * <p>
...
public interface PixelsContainer {
     ...
     *
     * @return the count of Pixel2D objects
     */
    int getLength();

    /**
     * Adds the specified Pixel2D to the end of this container.
     * <p>This operation is equivalent to "enqueueing" or "adding" an element
     * to the collection.</p>
     *
     * @param p the Pixel2D object to be added
     */
     ...
     *
     * @return the Pixel2D at the front of the container, or null if empty
     */
    Pixel2D dequeue();
     ...
     * @return the Pixel2D that was removed
