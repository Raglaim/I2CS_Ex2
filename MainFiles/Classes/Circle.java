...
public class Circle implements assignments.Ex2.MainFiles.Classes.Interfaces.Circle {
    ...
    /**
     * Constructs a Circle using a Pixel2D object as the center.
     *
     ...
     */
    @Override
    public assignments.Ex2.MainFiles.Classes.Interfaces.Circle copy() {
    ...
    /**
     * Returns the center of the circle as a Pixel2D object.
     * <p>Note: This returns a new Index2D instance representing the center.</p>
     *
    ...
    /**
     * Checks if a Pixel2D point is inside the circle.
     *
