 ...
 *  Compilation:  javac Program.StdDraw.java
 *  Execution:    java Program.StdDraw
 *  Dependencies: none
 *
...
/**
 *  The {@code Program.StdDraw} class provides static methods for creating drawings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code Program.StdDraw.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdDraw.java">Program.StdDraw.java</a>
 ...
 *           Program.StdDraw.setPenRadius(0.05);
 *           Program.StdDraw.setPenColor(Program.StdDraw.BLUE);
 *           Program.StdDraw.point(0.5, 0.5);
 *           Program.StdDraw.setPenColor(Program.StdDraw.MAGENTA);
 *           Program.StdDraw.line(0.2, 0.2, 0.8, 0.2);
 *       }
 *   }
 *  </pre>
 ...
 *  The methods {@code Program.StdDraw.line()} and {@code Program.StdDraw.point()}
 *  draw lines and points; the methods {@code Program.StdDraw.setPenRadius()}
 *  and {@code Program.StdDraw.setPenColor()} control the line thickness and color.
 *  <p>
 ...
 *  and represented in degrees. For example, {@code Program.StdDraw.arc(0.0, 0.0, 1.0, 0, 90)}
 ...
 *   Program.StdDraw.filledPolygon(x, y);
 *  </pre>
 *  <p>
 *  <b>Pen size.</b>
 ...
 *  </ul>
 *  <p>
 *  For example, {@code Program.StdDraw.setPenRadius(0.01)} makes
 ...
 *  and {@link #BLUE}.
 *  For example, {@code Program.StdDraw.setPenColor(Program.StdDraw.RED)} sets the
 *  pen color to red.
 *  <p>
 *  <b>Window title.</b>
 ...
 *  For example, {@code Program.StdDraw.setCanvasSize(800, 800)}
 ...
 *  leave a small margin, you can call {@code Program.StdDraw.setScale(-.05, 1.05)}.
 *  <p>
 ...
 *   Program.StdDraw.setFont(font);
 *   Program.StdDraw.text(0.5, 0.5, "Hello, World");
 *  </pre>
 *  <p>
 *  <b>Images.</b>
 ...
 *
 *  <p><b>File formats.</b>
 *  The {@code Program.StdDraw} class supports reading and writing images to any of the
 ...
 *  {@code Program.StdDraw.clear(Program.StdDraw.LIGHT_GRAY)} clears the canvas to a shade
 *  of gray. To make the background transparent,
 *  call {@code Program.StdDraw.clear(Program.StdDraw.TRANSPARENT)}.
 *
 *  <p>
 ...
 *  <pre>
 *   Program.StdDraw.setScale(-2.0, +2.0);
 *   Program.StdDraw.enableDoubleBuffering();
 *
 *   for (double t = 0.0; true; t += 0.02) {
 *       double x = Math.sin(t);
 *       double y = Math.cos(t);
 *       Program.StdDraw.clear();
 *       Program.StdDraw.filledCircle(x, y, 0.1);
 *       Program.StdDraw.filledCircle(-x, -y, 0.1);
 *       Program.StdDraw.show();
 *       Program.StdDraw.pause(20);
 *   }
 *  </pre>
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
     ...
     * To make the background transparent, use {@code Program.StdDraw.TRANSPARENT}.
     *
     ...
     * {@code Program.StdDraw.BLACK}, {@code Program.StdDraw.WHITE}, {@code Program.StdDraw.RED},
     * {@code Program.StdDraw.GREEN}, and {@code Program.StdDraw.BLUE}.
     *
    ...
    private static Image getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Program.StdDraw)
        if (icon.getImageLoadStatus() != MediaTracker.COMPLETE) {
...
/*
    private static BufferedImage getImage(String filename) {
        ...
        // in case file is inside a .jar (classpath relative to Program.StdDraw)
        try {
            URL url = Program.StdDraw.class.getResource(filename);
            BufferedImage image = ImageIO.read(url);
            return image;
        }
        catch (IOException e) {
